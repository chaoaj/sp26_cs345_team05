...
function preload() {
  ...
  over_music = loadSound("assets/GameOver.mp3");
  level_theme = loadSound("assets/Game_SoundTrack.mp3");
  potion_sound = loadSound("assets/Potion_Sound.mp3");
  slides = loadSound("assets/slides1.0.mp3");
  transit_victory = loadSound("assets/Victory.mp3");
...
function storySlides() {
  ...
  if (over_music.isPlaying()) {
    over_music.stop();
  }
  if (transit_victory.isPlaying()) {
    transit_victory.stop();
  }
